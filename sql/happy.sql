...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-11-26 14:42:09
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(32, 12, 0, '分配', '', '', '分配', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=12&id=32', 0, 99, 1, 0, 'baile', 1511706711, 1511706765),
...
(32, 1, 32, 1511706711, '分配 分配 黑体 百万 上市公司 小型企业 机房 设备 全线', 1);
...
('m0v1694h1qhpsujs2no4jq6646', 1, '', 1511707181, 1, 0, 'admin', 'index', 'public_session_life', 'code|s:0:"";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"dHepNv";lock_screen|i:0;');
...
--
ALTER TABLE `v9_log`
  MODIFY `logid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=558;
--
