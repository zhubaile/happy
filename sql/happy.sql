...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-11-27 05:15:09
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(1, 'baile', '8c5af5b05684d87234cffa7742055ff6', 1, 'aCHeGy', '', 1511756429, '601144080@qq.com', '', '', '');
...
(4, 12, 0, '公司概况', '', '', '', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=12&id=4', 0, 99, 1, 0, 'baile', 1511595578, 1511706806),
(32, 12, 0, '分配', '', '', '', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=12&id=32', 0, 99, 1, 0, 'baile', 1511706711, 1511756482),
...
(22, 13, 0, '2：计算机技术对我们生活的影响', '#FF0000', 'http://localhost/happy/uploadfile/2017/1126/20171126020732328.jpg', '', ' ', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=13&id=22', 0, 99, 1, 0, 'baile', 1511675262, 1511704358),
(23, 13, 0, '1：网络游戏的定义', '#FF0000', 'http://localhost/happy/uploadfile/2017/1126/20171126020514860.jpg', '网络游戏', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=13&id=23', 0, 99, 1, 0, 'baile', 1511675294, 1511758599),
(24, 14, 0, '互联网牛掰职位从这里开始', '', '', '', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=14&id=24', 1, 99, 1, 0, 'baile', 1511704575, 1511704660),
(28, 14, 0, '行业前景', '', '', '前景 行业', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=14&id=28', 0, 99, 1, 0, 'baile', 1511705254, 1511705270),
(26, 14, 0, '学习阶段了解', '', '', '氛围', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=14&id=26', 2, 99, 1, 0, 'baile', 1511704808, 1511705624),
(29, 14, 0, '六大核心保障', '', '', '核心', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=14&id=29', 0, 99, 1, 0, 'baile', 1511705950, 1511706139),
(30, 14, 0, '多重行业保证', '', '', '行业', '', 0, 'http://localhost/happy/index.php?m=content&c=index&a=show&catid=14&id=30', 0, 99, 1, 0, 'baile', 1511706006, 1511706023);
...
(22, '<div style="text-align: center; margin-left: 80px;"><span style="color:#ff0000;"><strong>计算机技术对我们生活的影响&nbsp;</strong></span></div>\r\n<div style="margin-left: 80px;"><em>伴随着计算机的普及与发展，&rdquo;Internet&rdquo;一词已经让我们不再感到陌生，随着E时代的来，新的理念和结构也在不断的形成和完善，网络给人类的工作学习和生活带来了极大的方便，计算机网络技术的发展对人类技术史的发展产生了不可磨灭的深远影响。但是，当我们看到网络带给我们利益的同时，也有着一些不容忽视的弊端的存在值得我们去探讨和深思。&nbsp;</em></div>\r\n<div style="margin-left: 80px;"><em>随着信息技术的广泛应用，它已经引起了社会各个方面，各个领域的深刻变革，加快了社会生产力的发展和人们的生活质量的提高。&nbsp;</em></div>\r\n<div style="margin-left: 80px;"><em>信息技术在人们日常生活中的影响已是不可小觑的了。最简单地，人们将广泛地利用信息网络，自觉或不自觉地使日常生活便捷化。信息技术的广泛应用促进了人们的工作效率和生活质量的提高，人们的工作方式和学习方式也正发生转变。足不出户可知天下事，人不离家照样能办事。一部分人可以由原来的按时定点上班变为可以在家上班，网上看病、网上授课、网上学习、网上会议、网上购物、网上洽谈生意、网上娱乐等成为人们一种新型的生活方式。网络技术、多媒体技术在教学上的应用，使得人们的学习内容更丰富、学习方式更灵活。另一方面，信息技术促进了新技术的变革，极大地推动了科学技术的进步。计算机技术的应用，帮助人们攻克了一个又一个科学难题，使得原本用人工需要花几十年甚至上百年才能解决的复杂的计算，用计算机可能几分钟就能完成。应用计算机仿真技术可以模拟现实中可能出现的各种情况，便于验证各种科学的假设。&nbsp;</em></div>\r\n<div style="margin-left: 80px;"><em>计算机网络技术的发展虽然对人类社会的发展起到了不可磨灭的推动作用，但是作用与反作用往往是并存的，在技术发展的背后引发出的种种问题也是显而易见的。&nbsp;</em></div>\r\n<div style="margin-left: 80px;"><em>&nbsp; &nbsp; 首先，正是因为网络空间的这种虚拟性，让人们过于的在这个空间里放纵自己，沉迷于这样的虚拟世界，人们往往在现实中解决不了的问题喜欢跑到幻想中去解决，比如电脑游戏，它给人一种逃避现实性的途径，在游戏中扮演一个自己从未体验过的角色或者是在现实中根本不可能实现的梦想，从而使人们过于沉迷于游戏，沉迷于网络。再者，网络的开放性使得个人的隐私安全得不到根本的保障。另一方面，网络使现实的真实的社会道德关系日趋松散，使人际关系淡漠，情感疏远。Internet改变了个体交往的方式，使人与人之间的交流变成了人与机器之间的交谈，感情的直接交流越来越小，人与人之间的依赖关系逐渐被人对网络的依赖关系所取代。这种状况在网络发达的社会中已有充分的表现，即使是在我国目前网络欠发达的情况下也有一定程度的反映。数字化、电子化在一定意义上会无情地伤害人类。&nbsp;</em></div>\r\n<div style="margin-left: 80px;"><em>技术的进步给了人们以更大的信息支配能力，也要求人们更严格地控制自己的行为。唯有如此，我们才能最大限度地利用网络的便利并去除其弊端。</em></div>\r\n', 0, '', 2, 10000, '', 0, '', 0, 1, '|0'),
...
(30, '<div class="part bg2" style="margin: 0px auto; padding: 0px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, Verdana, Arial, Helvetica, sans-serif; color: rgb(153, 153, 153); width: 1349px; overflow: hidden; background: url(&quot;../img/bg2.jpg&quot;) center center repeat;">\r\n<div class="title wow fadeInDown animated" data-wow-delay="0.2s" style="margin: 0px 0px 50px; padding: 60px 0px 16px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; width: 1349px; text-align: center; background: url(&quot;../img/title-line.png&quot;) center bottom no-repeat; visibility: visible; animation-delay: 0.2s;">\r\n<h1 style="margin: 0px; padding: 0px; font-weight: normal; font-size: 42px; color: rgb(65, 70, 77); line-height: 42px;"><span style="color: rgb(0, 150, 255);">多重教学</span>保障服务</h1>\r\n</div>\r\n<div class="main" style="margin: 0px auto; padding: 0px; width: 1200px;">\r\n<div class="container4 clearfix" style="margin: 0px 0px 0px 100px; padding: 0px 0px 100px;">\r\n<div class="box b1 wow fadeInDown animated" data-wow-delay="0.3s" style="margin: 0px 10px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; float: left; width: 192px; height: 360px; position: relative; transition: 0.2s; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border-radius: 3px; visibility: visible; animation-delay: 0.3s;">\r\n<div class="tag" style="margin: 0px; padding: 0px; width: 192px; height: 106px; transition: 0.5s; background-position: center bottom; background-repeat: no-repeat; background-image: url(&quot;img/ctn4-tag1.png&quot;);">&nbsp;</div>\r\n<div class="info" style="margin: 0px; padding: 0px;">\r\n<h2 style="margin: 12px 0px 0px; padding: 0px; font-size: 18px; color: rgb(0, 150, 255); line-height: 24px; text-align: center;">课上<br />\r\n讲师精讲</h2>\r\n<p style="margin: 10px 0px 0px; padding: 0px 15px; font-size: 13px; line-height: 24px;">总监级技术专家主讲，理论与实践相结合，知识模块与项目案例相结合，边讲边演示代码，学员人手一台电脑，边学边练；专家组合授课，每个讲师只讲自己擅长的部分；</p>\r\n</div>\r\n</div>\r\n<div class="box b2 wow fadeInDown animated" data-wow-delay="0.4s" style="margin: 0px 10px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; float: left; width: 192px; height: 360px; position: relative; transition: 0.2s; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border-radius: 3px; visibility: visible; animation-delay: 0.4s;">\r\n<div class="tag" style="margin: 0px; padding: 0px; width: 192px; height: 106px; transition: 0.5s; background-position: center bottom; background-repeat: no-repeat; background-image: url(&quot;img/ctn4-tag2.png&quot;);">&nbsp;</div>\r\n<div class="info" style="margin: 0px; padding: 0px;">\r\n<h2 style="margin: 12px 0px 0px; padding: 0px; font-size: 18px; color: rgb(0, 150, 255); line-height: 24px; text-align: center;">早自习<br />\r\n项目经理辅导</h2>\r\n<p style="margin: 10px 0px 0px; padding: 0px 15px; font-size: 13px; line-height: 24px;">学员轮流将自己掌握的好的知识点做全班分享，温习了技术知识点的同时也锻炼提高了沟通表达能力；</p>\r\n</div>\r\n</div>\r\n<div class="box b3 wow fadeInDown animated" data-wow-delay="0.5s" style="margin: 0px 10px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; float: left; width: 192px; height: 360px; position: relative; transition: 0.2s; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border-radius: 3px; visibility: visible; animation-delay: 0.5s;">\r\n<div class="tag" style="margin: 0px; padding: 0px; width: 192px; height: 106px; transition: 0.5s; background-position: center bottom; background-repeat: no-repeat; background-image: url(&quot;img/ctn4-tag3.png&quot;);">&nbsp;</div>\r\n<div class="info" style="margin: 0px; padding: 0px;">\r\n<h2 style="margin: 12px 0px 0px; padding: 0px; font-size: 18px; color: rgb(0, 150, 255); line-height: 24px; text-align: center;">晚自习<br />\r\n项目经理串讲、辅导</h2>\r\n<p style="margin: 10px 0px 0px; padding: 0px 15px; font-size: 13px; line-height: 24px;">项目经理带领学员完成讲师当天布置的作业及当天的案例，项目经理全程辅导并将当天课程的重点难点给学员做串讲；</p>\r\n</div>\r\n</div>\r\n<div class="box b4 wow fadeInDown animated" data-wow-delay="0.6s" style="margin: 0px 10px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; float: left; width: 192px; height: 360px; position: relative; transition: 0.2s; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border-radius: 3px; visibility: visible; animation-delay: 0.6s;">\r\n<div class="tag" style="margin: 0px; padding: 0px; width: 192px; height: 106px; transition: 0.5s; background-position: center bottom; background-repeat: no-repeat; background-image: url(&quot;img/ctn4-tag4.png&quot;);">&nbsp;</div>\r\n<div class="info" style="margin: 0px; padding: 0px;">\r\n<h2 style="margin: 12px 0px 0px; padding: 0px; font-size: 18px; color: rgb(0, 150, 255); line-height: 24px; text-align: center;">每周一测<br />\r\n每月一测</h2>\r\n<p style="margin: 10px 0px 0px; padding: 0px 15px; font-size: 13px; line-height: 24px;">每周进行一次周考、每月进行一次月考，根据考试结果分析学员对知识点的掌握情况，由项目经理进行1对1或1对多的辅导和串讲，直到学员熟练掌握；</p>\r\n</div>\r\n</div>\r\n<div class="box b5 wow fadeInDown animated" data-wow-delay="0.7s" style="margin: 0px 10px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; float: left; width: 192px; height: 360px; position: relative; transition: 0.2s; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border-radius: 3px; visibility: visible; animation-delay: 0.7s;">\r\n<div class="tag" style="margin: 0px; padding: 0px; width: 192px; height: 106px; transition: 0.5s; background-position: center bottom; background-repeat: no-repeat; background-image: url(&quot;img/ctn4-tag5.png&quot;);">&nbsp;</div>\r\n<div class="info" style="margin: 0px; padding: 0px;">\r\n<h1 style="margin: 21px 0px 0px; padding: 0px; font-size: 18px; color: rgb(0, 150, 255); line-height: 18px; text-align: center;">线上学习</h1>\r\n<p style="margin: 10px 0px 0px; padding: 0px 15px; font-size: 13px; line-height: 24px;">每周进行一次周考、每月进行一次月考，根据考试结果分析学员对知识点的掌握情况，由项目经理进行1对1或1对多的辅导和串讲，直到学员熟练掌握；</p>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class="part" style="margin: 0px auto; padding: 0px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, Verdana, Arial, Helvetica, sans-serif; color: rgb(153, 153, 153); width: 1349px; overflow: hidden; position: relative;">\r\n<div class="title wow fadeInDown animated" data-wow-delay="0.2s" style="margin: 0px 0px 50px; padding: 60px 0px 16px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInDown; width: 1349px; text-align: center; background: url(&quot;../img/title-line.png&quot;) center bottom no-repeat; visibility: visible; animation-delay: 0.2s;">\r\n<h1 style="margin: 0px; padding: 0px; font-weight: normal; font-size: 42px; color: rgb(65, 70, 77); line-height: 42px;"><span style="color: rgb(0, 150, 255);">多重就业</span>保障服务</h1>\r\n</div>\r\n<div class="main" style="margin: 0px auto; padding: 0px; width: 1200px; position: relative;">\r\n<div class="container5 clearfix" id="ctn5" style="margin: 0px 0px 0px 100px; padding: 0px 0px 100px;">\r\n<div class="box wow fadeInUp animated" data-wow-delay="0.3s" style="margin: 0px 66px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInUp; float: left; width: 200px; height: 280px; visibility: visible; animation-delay: 0.3s;"><img src="http://localhost/happy/uploadfile/2017/1126/20171126102023732.png" style="border: 0px; margin: 0px auto; display: block;" />\r\n<h1 style="margin: 25px 0px 0px; padding: 0px; font-weight: normal; font-size: 18px; color: rgb(77, 77, 77); line-height: 24px; text-align: center;">企业定制</h1>\r\n<p style="margin: 12px 0px 0px; padding: 0px; font-size: 12px; line-height: 20px; text-align: center;">针对不少企业会出现在特定时间内，对同一岗位有大量人才需求的 情况，达内通过整合招生渠道，从初期学员招募、到人员筛选，再到 培训实施，为企业提供一体化招聘、培训服务；</p>\r\n</div>\r\n<div class="box wow fadeInUp animated" data-wow-delay="0.4s" style="margin: 0px 66px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInUp; float: left; width: 200px; height: 280px; visibility: visible; animation-delay: 0.4s;"><img src="http://localhost/happy/uploadfile/2017/1126/20171126102023407.png" style="border: 0px; margin: 0px auto; display: block;" />\r\n<h1 style="margin: 25px 0px 0px; padding: 0px; font-weight: normal; font-size: 18px; color: rgb(77, 77, 77); line-height: 24px; text-align: center;">每日-企业双选会</h1>\r\n<p style="margin: 12px 0px 0px; padding: 0px; font-size: 12px; line-height: 20px; text-align: center;">15年来，达内与全国众多企业建立了合作关系，几乎每天都有企业直接到达内全国各个校区进行人才选拔；</p>\r\n</div>\r\n<div class="box wow fadeInUp animated" data-wow-delay="0.5s" style="margin: 0px 66px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInUp; float: left; width: 200px; height: 280px; visibility: visible; animation-delay: 0.5s;"><img src="http://localhost/happy/uploadfile/2017/1126/20171126102023789.png" style="border: 0px; margin: 0px auto; display: block;" />\r\n<h1 style="margin: 25px 0px 0px; padding: 0px; font-weight: normal; font-size: 18px; color: rgb(77, 77, 77); line-height: 24px; text-align: center;">每月-名企有约活动</h1>\r\n<p style="margin: 12px 0px 0px; padding: 0px; font-size: 12px; line-height: 20px; text-align: center;">达内每月举办&ldquo;名企有约&rdquo;活动，邀请有人才需求的知名企业来达内校区，与学员直接面对面交流，搭起学员入职名企的新通道；</p>\r\n</div>\r\n<div class="box wow fadeInUp animated" data-wow-delay="0.6s" style="margin: 0px 66px 0px 0px; padding: 0px; animation-duration: 1s; animation-fill-mode: both; animation-name: fadeInUp; float: left; width: 200px; height: 280px; visibility: visible; animation-delay: 0.6s;"><img src="http://localhost/happy/uploadfile/2017/1126/20171126102023758.png" style="border: 0px; margin: 0px auto; display: block; animation: ani1 1s linear infinite;" />\r\n<h1 style="margin: 25px 0px 0px; padding: 0px; font-weight: normal; font-size: 18px; color: rgb(77, 77, 77); line-height: 24px; text-align: center;">每季度-大型专场招聘会</h1>\r\n<p style="margin: 12px 0px 0px; padding: 0px; font-size: 12px; line-height: 20px; text-align: center;">达内平均每季度在各个城市举办一次大型人才专场招聘会，只针对达内学员，邀请当地企业知名企业参加，保障学员顺利就业；</p>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<br />\r\n', 0, '', 0, 10000, '', 0, '', 0, 1, '|0'),
(32, '<span style="background-color: rgb(245, 245, 245); color: rgb(138, 138, 138); font-family: 黑体; font-size: 18px; text-align: center;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 从小型企业到美国上市公司，从桌运维到百万级机房全线设备</span><br />\r\n<img height="571" src="http://localhost/happy/uploadfile/2017/1126/20171126103207358.png" style="padding: 0px; margin: 0px; vertical-align: top; color: rgb(0, 0, 0); font-family: 黑体; font-size: medium; text-align: center; background-color: rgb(245, 245, 245);" width="1024" />', 0, '', 0, 10000, '', 0, '', 0, 1, '|0');
...
(16, '关于我们', ';', '', '<br />\r\n<div background-attachment:="" background-clip:="" background-image:="" background-origin:="" background-position:="" background-repeat:="" background-size:="" center="" class="join ui_bg" color:="" http:="" images="" microsoft="" res0.qijixueyuan.com.cn="" specialty="" style="margin: 0px; padding: 100px 0px 80px; border: 0px; font-variant-numeric: inherit; font-stretch: inherit; font-size: 16px; line-height: inherit; vertical-align: baseline; font-family: " uib="">\r\n<div class="wrap" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; width: 960px; position: relative;"><img alt="" class="join_img" src="http://res0.qijixueyuan.com.cn/images/specialty/wysjB/ping1.png!normal" style="margin: 50px auto 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto;" />\r\n<ul style="margin: 0px; padding-right: 0px; padding-left: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; position: absolute; top: 413px;">\r\n<li class="li1" style="margin: 0px 0px 0px 30px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 171px; float: left;"><span class="btn leyu" style="margin: 0px auto 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 18px; line-height: 38px; vertical-align: baseline; overflow: hidden; display: block; cursor: pointer; box-sizing: border-box; background: rgb(194, 0, 128); width: 171px; color: rgb(255, 255, 255); text-align: center; border-radius: 0px; height: 38px;">岗位多</span>\r\n<p style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 18px; vertical-align: baseline; word-wrap: break-word; color: rgb(51, 51, 51);">互联网+ui是时代主流、公司标配涵盖互联网、金融教育、通信建筑、广告、媒体等企业。</p>\r\n</li>\r\n<li class="li2" style="margin: 0px 0px 0px 74px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 171px; float: left;"><span class="btn leyu" style="margin: 0px auto 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 18px; line-height: 38px; vertical-align: baseline; overflow: hidden; display: block; cursor: pointer; box-sizing: border-box; background: rgb(194, 0, 128); width: 171px; color: rgb(255, 255, 255); text-align: center; border-radius: 0px; height: 38px;">薪资高</span>\r\n<p style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 18px; vertical-align: baseline; word-wrap: break-word; color: rgb(51, 51, 51);">智联招聘数据显示，UI设计师平均薪资达11640元毕业起薪6-8k高于同水平其他行业薪资20%。</p>\r\n</li>\r\n<li class="li3" style="margin: 0px 0px 0px 75px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 171px; float: left;"><span class="btn leyu" style="margin: 0px auto 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 18px; line-height: 38px; vertical-align: baseline; overflow: hidden; display: block; cursor: pointer; box-sizing: border-box; background: rgb(194, 0, 128); width: 171px; color: rgb(255, 255, 255); text-align: center; border-radius: 0px; height: 38px;">晋升快</span>\r\n<p style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 18px; vertical-align: baseline; word-wrap: break-word; color: rgb(51, 51, 51);">UI设计师的职业发展呈现两条不同的路径，产品设计与创意设计双线发展，更有无限可能。</p>\r\n</li>\r\n<li class="li4" style="margin: 0px 0px 0px 74px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 171px; float: left;"><span class="btn leyu" style="margin: 0px auto 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 18px; line-height: 38px; vertical-align: baseline; overflow: hidden; display: block; cursor: pointer; box-sizing: border-box; background: rgb(194, 0, 128); width: 171px; color: rgb(255, 255, 255); text-align: center; border-radius: 0px; height: 38px;">空间大</span>\r\n<p style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 18px; vertical-align: baseline; word-wrap: break-word; color: rgb(51, 51, 51);">Ui所需技能大同小异，掌握核心原理+创作思维，就能实现各种设计职位的跨界，职业发展路径更宽。</p>\r\n</li>\r\n</ul>\r\n<a class="btn1 leyu" style="margin: 35px auto 0px; padding: 0px; border: 1px solid rgb(194, 0, 128); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 20px; line-height: 43px; vertical-align: baseline; display: block; color: rgb(194, 0, 128); width: 198px; height: 43px; text-align: center;">我要入行</a></div>\r\n</div>\r\n<div background:="" class="softer" color:="" height:="" microsoft="" style="margin: 0px; padding: 105px 0px 80px; border: 0px; font-variant-numeric: inherit; font-stretch: inherit; font-size: 16px; line-height: inherit; vertical-align: baseline; font-family: " width:="">\r\n<div class="wrap" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; width: 960px; position: relative;">\r\n<ul style="margin: 0px; padding-right: 0px; padding-left: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; position: absolute; top: -1px; overflow: hidden; cursor: pointer;">\r\n<li class="li3 leyu" style="margin: 0px 0px 0px 87px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 63px; height: 63px; float: left; cursor: pointer;">&nbsp;</li>\r\n<li class="li3 leyu" style="margin: 0px 0px 0px 87px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 63px; height: 63px; float: left; cursor: pointer;">&nbsp;</li>\r\n<li class="li4 leyu" style="margin: 0px 0px 0px 159px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 63px; height: 63px; float: left; cursor: pointer;">&nbsp;</li>\r\n<li class="li5 leyu" style="margin: 0px 0px 0px 15px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; width: 63px; height: 63px; float: left; cursor: pointer;">&nbsp;</li>\r\n</ul>\r\n</div>\r\n</div>\r\n<div background-attachment:="" background-clip:="" background-image:="" background-origin:="" background-position:="" background-repeat:="" background-size:="" center="" class="ping1 padding ui_bg" color:="" http:="" images="" microsoft="" res0.qijixueyuan.com.cn="" specialty="" style="margin: 0px; padding: 110px 0px; border: 0px; font-variant-numeric: inherit; font-stretch: inherit; font-size: 16px; line-height: inherit; vertical-align: baseline; font-family: " uib="" width:="">\r\n<div class="wrap" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; width: 822px;">\r\n<div class="title" color:="" sourcehansanscn="" style="margin: 0px auto; padding: 0px 0px 30px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 36px; line-height: inherit; vertical-align: baseline; font-family: " text-align:="">&nbsp; &nbsp; &nbsp; 敢签协议 &mdash;&mdash; 保证学员就业保障学员薪水</div>\r\n<div class="small_text" color:="" pingfang="" sc="" style="margin: 0px 0px 35px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 12px; line-height: inherit; vertical-align: baseline; font-family: " text-align:="">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 顺利毕业，成绩达到30%的A率</div>\r\n<div class="box" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; overflow: hidden;">\r\n<div class="fl" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; float: left;"><img alt="" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/phone.jpg!normal" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto;" />\r\n<div class="round leyu" style="margin: 30px 0px 0px; padding: 30px 30px 0px; border: 1px solid rgb(255, 255, 255); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; width: 192px; height: 226px; background: rgb(241, 241, 241); cursor: pointer;"><img alt="" class="swing" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/round3.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto; transform: rotate(0deg); animation-name: swing; animation-duration: 1s; animation-timing-function: linear; animation-delay: 0s; animation-iteration-count: infinite; cursor: pointer;" />\r\n<p class="title_small" color:="" sourcehansanscn="" style="margin: 18px 0px 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 18px; line-height: 20px; vertical-align: baseline; font-family: " text-align:="" word-wrap:="">协议保薪，全额退款</p>\r\n<p color:="" microsoft="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 20px; vertical-align: baseline; font-family: " word-wrap:="">入学即签订保证薪水协议正规且具备法律效应如就业未达预期，学费全额退。</p>\r\n</div>\r\n</div>\r\n<div class="fr" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; float: right;"><img alt="" class="qiji" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/qiji.jpg!normal" style="margin: 52px 0px 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto;" />\r\n<ul class="box" style="margin: 0px; padding-right: 0px; padding-left: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; overflow: hidden; width: 537px;">\r\n<li class="fl round leyu" style="margin: 30px 0px 0px; padding: 30px 30px 0px; border: 1px solid rgb(255, 255, 255); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; float: left; width: 192px; height: 226px; background: rgb(241, 241, 241); cursor: pointer;"><img alt="" class="swing" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/round1.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto; transform: rotate(0deg); animation-name: swing; animation-duration: 1s; animation-timing-function: linear; animation-delay: 0s; animation-iteration-count: infinite; cursor: pointer;" />\r\n<p class="title_small" color:="" sourcehansanscn="" style="margin: 18px 0px 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 18px; line-height: 20px; vertical-align: baseline; font-family: " text-align:="" word-wrap:="">零风险试学</p>\r\n<p color:="" microsoft="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 20px; vertical-align: baseline; font-family: " word-wrap:="">入学即签订保证薪水协议正规且具备法律效应如就业未达预期，学费全额退。</p>\r\n</li>\r\n<li class="fr round leyu" style="margin: 30px 0px 0px; padding: 30px 30px 0px; border: 1px solid rgb(255, 255, 255); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; float: right; width: 192px; height: 226px; background: rgb(241, 241, 241); cursor: pointer;"><img alt="" class="swing" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/round2.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto; transform: rotate(0deg); animation-name: swing; animation-duration: 1s; animation-timing-function: linear; animation-delay: 0s; animation-iteration-count: infinite; cursor: pointer;" />\r\n<p class="title_small" color:="" sourcehansanscn="" style="margin: 18px 0px 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 18px; line-height: 20px; vertical-align: baseline; font-family: " text-align:="" word-wrap:="">不满意无障碍退款</p>\r\n<p color:="" microsoft="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 20px; vertical-align: baseline; font-family: " word-wrap:="">30天内若发现不合适，可选退费或调剂专业，六大热门就业方向可供选择。</p>\r\n</li>\r\n<li class="fl round leyu" style="margin: 30px 0px 0px; padding: 30px 30px 0px; border: 1px solid rgb(255, 255, 255); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; float: left; width: 192px; height: 226px; background: rgb(241, 241, 241); cursor: pointer;"><img alt="" class="swing" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/round4.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto; transform: rotate(0deg); animation-name: swing; animation-duration: 1s; animation-timing-function: linear; animation-delay: 0s; animation-iteration-count: infinite; cursor: pointer;" />\r\n<p class="title_small" color:="" sourcehansanscn="" style="margin: 18px 0px 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 18px; line-height: 20px; vertical-align: baseline; font-family: " text-align:="" word-wrap:="">免费重学</p>\r\n<p color:="" microsoft="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 20px; vertical-align: baseline; font-family: " word-wrap:="">如就业未达预期，可自由自主选择全程就业课程免费重学，终身提供就业服务</p>\r\n</li>\r\n<li class="fr round leyu" style="margin: 30px 0px 0px; padding: 30px 30px 0px; border: 1px solid rgb(255, 255, 255); font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; list-style: none; float: right; width: 192px; height: 226px; background: rgb(241, 241, 241); cursor: pointer;"><img alt="" class="swing" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/round5.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto; transform: rotate(0deg); animation-name: swing; animation-duration: 1s; animation-timing-function: linear; animation-delay: 0s; animation-iteration-count: infinite; cursor: pointer;" />\r\n<p class="title_small" color:="" sourcehansanscn="" style="margin: 18px 0px 10px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 18px; line-height: 20px; vertical-align: baseline; font-family: " text-align:="" word-wrap:="">助学分期付款</p>\r\n<p color:="" microsoft="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 20px; vertical-align: baseline; font-family: " word-wrap:="">学生或待业可选择，助学分期贷款支付学费，减轻经济压。</p>\r\n</li>\r\n</ul>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div background:="" class="xieyi" color:="" height:="" microsoft="" style="margin: 0px; padding: 100px 0px; border: 0px; font-variant-numeric: inherit; font-stretch: inherit; font-size: 16px; line-height: inherit; vertical-align: baseline; font-family: " text-align:="" width:="">\r\n<div class="wrap" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; width: 960px;">\r\n<div class="title_black" color:="" sourcehansanscn="" style="margin: 0px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: bold; font-stretch: inherit; font-size: 36px; line-height: inherit; vertical-align: baseline; font-family: ">&nbsp; &nbsp; &nbsp;入学即签保薪协议，每收一名新生送出一份踏实</div>\r\n<p color:="" microsoft="" style="margin: 24px auto 42px; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 14px; line-height: 28px; vertical-align: baseline; font-family: " text-align:="" width:="" word-wrap:="">&nbsp; &nbsp; &nbsp; 奇迹曼特成立6年，发展至今毕业上千学生，全国各地保障学生的就业问题，通过互联网教学平台精细化教学管理，通过引进国际设计总监、制作总监和组长参与学生的全程学习，我们于2017年推出行业望而却步的保薪班服务，开创了设计培训领域的新高度。</p>\r\n<img alt="" class="img_3" src="http://res0.qijixueyuan.com.cn/images/specialty/uiB/xieyi.png!normal" style="margin: 0px auto; padding: 0px; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; vertical-align: baseline; display: block; height: auto;" /></div>\r\n<div>&nbsp;</div>\r\n</div>\r\n<br />\r\n', '', 0);
...
(4, 1, 4, 1511595578, '公司概况  学堂 主题 未来 主办 学习 创造 人才 金融人才 行业 人才培养 时间 地点 杰出 培训 服务 供应商 大奖 解决方案 细分 论坛 举行 在即 发布 杂志 模式 高度 新浪网 闭幕 携手 认可 产品 商业 中国企业 升级 成都 助手 发展 总监 平台 智能 企业 进化 企业培训 激活 公司 组织 查看 更多 市场 活动 网易 揭晓 进入 榜单 培养 互联网 年会 趋势 制造业 我们 美好 相信 选择 他们 概况 财经网 研究会 人力 年中国 年度 新闻 金融 学院 共同 银行 举办 由中国 新闻网 中国经济', 1),
...
(22, 1, 22, 1511675262, '2：计算机技术对我们生活的影响  人们 网络 计算机 我们 技术 网上 生活 的发展 社会 学习 应用 现实 人类 工作 网络技术 不可 使得 关系 之间 自己 解决 方式 可以 广泛 一个 的影响 随着 变革 交流 推动 发达 根本 才能 已经 另一方面 依赖 质量 自觉 游戏 促进 进步 信息 利用 发展 提高 科学 一定 这种 但是 情况 虚拟 空间 作用 问题 往往 极大 过于 各种 弊端 可能 上班 安全 隐私 或者 梦想 从未 个人 体验 实现 角色 从而 开放性 逃避 这个 因为 正是 显而易见 首先 这样 世界 不到 途径 电脑游戏 比如 不了 喜欢 幻想 扮演 情感 电子化 数字化 意义 上会 无情 反映 程度 表现 即使 我国 目前 伤害 支配 最大 如此 限度 便利 唯有 行为 能力 要求 严格 控制 充分 已有 发出 改变 人际关系 真实 道德 日趋 个体 交往 越来越 逐渐 取代 状况 直接 感情 的方式 变成 机器 交谈 保障 可能出现 加快 生产力 简单 深刻 各个领域 引起 各个 方面 便捷 效率 办事 部分 普及 天下 发生 转变 可知 不再 感到 产生了 时代 深远 影响 理念 结构 形成 不断 带来 方便 看到 带给 值得 探讨 深思 陌生 存在 利益 同时 有着 一些 原来 按时 复杂 计算 分钟 甚至 几十 难题 原本 用人 需要 完成 虽然 起到 并存 假设 验证 模拟 完善 便于 攻克 网上购物 洽谈 生意 娱乐 会议 授课 变为 在家 成为 新型 灵活 新技术 科学技术 帮助 丰富 内容 生活方式 多媒体 教学 背后', 1),
...
(24, 1, 24, 1511704575, '互联网牛掰职位从这里开始  课程 开发 优势 技术 企业 学习 工程师 互联网 项目 学员 授课 能力 不同 需求 流程 实战 采用 掌握 数据 设计 用户 网站 主流 讲解 提升 根据 基础 讲师 云计算 可以 案例 职位 培养 开始 更新 这里 服务器 职场 幅度 超过 模块 所用 同步 兼顾 实用 内容 前沿 所学 简单 语言 员工 层次 需要 真实 扩大就业 选择 空间 做人 激情 我们 课堂 快乐 励志 风格 幽默 生动 全方位 框架 引入 时期 等级 总监 标准 定期 并且 来自 高校 一线 亲自 小时 老师 全程 感受 不是 百万 不会 实时 工业化 管理 衔接 致力 深入 自动化 不怕 以人为本 敏捷 基于 上线 深度 机器 结合 更好 辅导 适合 论坛 目的 门户网站 想到 领域 方式 编写 很快 进入 入门 独立 分析 数据库 模式 具有 带领 周期 要求 通过 专家 过程 利用 升级 一次 半年 岗位 全部 市场 步伐 行业 覆盖 绝对 使用 完全 方法 为主 名师 研究 设计师 美学 知识 体系 指导 现场 着手 迅速 工作 公司 体验 百度 共同 研发 知名 全能 完整 非常 高度 规范 编码 熟练 应用 联合 巨大 导向 真正 思想 编程 维护 后台 大型 经验', 1),
(28, 1, 28, 1511705254, '行业前景 前景 行业 行业 途径 待遇 能够 企业 学习 人才 随之 不断 系统 要求 开发 从业 保证 效果 快速 自己 培训 行业发展 人才需求 决定 需要 具备 专业性 技术性 特别 有保障 就业 效率 一般 应届 计算机 其他 弊端 专业 学历 被迫 放弃 只能 下来 自学 时间 备受 技能 扎实 掌握 只有 比较 网络营销 方向 对于 拥有 一定 岗位 上岗 工作 相关 胜任 项目 实践 经验 软件开发 职位 寿命 迅速 职业 火爆 程度 接触 突破 得到 充实 技术 资讯 了解 十一 攀升 日趋 迅猛 前景 产业 产值 带来 需求 薪资 必然 发展 增长 自我 提升 基础 选择 参加 优势 有效 进入 软件测试 未来 分布 数字 越来越 移动 硬件 软件技术', 1),
(26, 1, 26, 1511704808, '学习阶段了解 氛围 阶段 开发 工程师 学习 实战 项目 冲刺 毕业 算法 行业 课程 面向 对象 应用 综合 数据 代码 全能 设计 公众 数据库 第二 处理 异常 操作 模块 第三 框架 技术开发 现代 接口 分析 机器 深度 第八 科学 网络 脚本 编程 运用 所学 准备 面试 大型 知识 就业 最后 编写 文件 版本 文档 方法 管理 流程 敏捷 第五 自动化 重构 测试 驱动 软件开发 技能 打造 人才 前沿 潮流 大纲 技术 设计师 了解 氛围 现状 落后 体系 用人 需求 引领 拯救 传统 云计算 第一 字符串 解析 时间 语法 基本 入门 精通 企业 日历', 1),
(30, 1, 30, 1511706006, '多重行业保证 行业 学员 进行 企业 项目 经理 每月 掌握 辅导 一次 多重 名企 讲师 当天 情况 保障 针对 考试 结果 人才需求 直到 活动 有约 根据 自己 人才 就业 每周 全国 熟练 分析 校区 各个 直接 举办 知名企业 大型 招聘会 服务 季度 专场 行业 专家 案例 结合 邀请 技术 通道 城市 选拔 交流 整合 渠道 招生 当地 大量 岗位 同一 时间 顺利 通过 初期 面对面 参加 平均 提供 众多 实施 培训 一体化 招聘 年来 每日 建立 筛选 人员 合作关系 几乎 每天 到达 招募 完成 组合 授课 电脑 演示 代码 每个 擅长 部分 模块 知识 教学 保证 理论 实践 主讲 总监 分享 同时 学习 不少 现在 定制 难点 能力 表达 沟通 锻炼 提高 带领 课程 重点 全程 作业 布置 特定', 1),
(29, 1, 29, 1511705950, '六大核心保障 核心 学习 老师 作业 笔记 可以 核心 小组 关怀 保障 同学 兄弟 六大 学生 名单 要求 免费 情况 定期 检查 不会 成员 申请 教务 原因 扎实 本期 解决 共同 学会 讨论 直到 效果 或者 严格 代码 相应 集体 全体 不成 是否 任务 为止 第二 习惯 养成 内容 重点 心里 做到 难点 必须 人性化 严格规范 遇到 问题 一再 强调 关注 每个 机制 法宝 会议 怎么办 一经 入学 完成 同步 视频 可以通过 服务 弥补 进度 召开 跟踪 项目 阶段 学员 进入 形成 测验 根据 复习 讲解 考核 方式 专业 随时 流程 分为 反馈 进行 针对 每周 整理 所有', 1),
(32, 1, 32, 1511706711, '分配  黑体 百万 上市公司 小型企业 分配 机房 设备 全线', 1);
...
('8f0g7nt7i0o19t62uh9idp6ga5', 1, '', 1511759632, 1, 0, 'admin', 'index', 'public_session_life', 'code|s:0:"";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"nEqspG";lock_screen|i:0;');
...
--
ALTER TABLE `v9_attachment`
  MODIFY `aid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
...
--
ALTER TABLE `v9_log`
  MODIFY `logid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=579;
--
...
--
ALTER TABLE `v9_search`
  MODIFY `searchid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
