...
<!--        <div class="main-goal-top">
        ...
        <div class="top">
            ...
            <div class="lbtp"><img src="<?php echo IMG_PATH;?>image/lunbo/2.png" alt=""/></div>
            <div class="lbtp"><img src="<?php echo IMG_PATH;?>image/lunbo/3.png" alt=""/></div>
            <div class="lbtp"><img src="<?php echo IMG_PATH;?>image/lunbo/4.png" alt=""/></div>
            <div class="lbtp"><img src="<?php echo IMG_PATH;?>image/lunbo/5.png" alt=""/></div>
            <div class="lbtp"><img src="<?php echo IMG_PATH;?>image/lunbo/6.png" alt=""/></div>
        </div>
        <div class="but">
            <ul>
